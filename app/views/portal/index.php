        ...
        <div class="col-md-4">
            <div class="card card-dashboard text-center h-100">
                <div class="card-body py-4">
                    ...
                    <h3 class="text-primary mb-2" data-portal="ahorro">$ <?= number_format(floatval($cuenta['saldo_obligatorio'] ?? 0) + floatval($cuenta['saldo_excedente'] ?? 0), 2) ?></h3>
        ...
        <div class="col-md-4">
            <div class="card card-dashboard text-center h-100">
                <div class="card-body py-4">
                    ...
                    <h3 class="text-success mb-2" data-portal="capital_inversion">$ <?= number_format($capital_inversion, 2) ?></h3>
        ...
        <div class="col-md-4">
            <div class="card card-dashboard text-center h-100">
                <div class="card-body py-4">
                    ...
                    <h3 class="text-danger mb-2" data-portal="valores_pagar">$ <?= number_format($valores_pagar, 2) ?></h3>
