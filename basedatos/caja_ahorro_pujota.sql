...
CREATE TABLE `amortizaciones` (
  `id_amortizaci├│n` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Identificador ├║nico de la amortizaci├│n (UUID)',
  `id_cr├®dito` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'FK al cr├®dito asociado',
  `n├║mero_cuota` int NOT NULL COMMENT 'N├║mero de cuota (1, 2, 3...)',
  ...
  `inter├®s` decimal(12,2) NOT NULL COMMENT 'Porci├│n de inter├®s de la cuota',
  ...
  PRIMARY KEY (`id_amortizaci├│n`),
  KEY `idx_amortizaciones_cr├®dito` (`id_cr├®dito`),
  KEY `idx_amortizaciones_estado` (`estado`),
  CONSTRAINT `amortizaciones_ibfk_1` FOREIGN KEY (`id_cr├®dito`) REFERENCES `cr├®ditos` (`id_cr├®dito`) ON DELETE CASCADE
...
CREATE TABLE `archivos` (
  ...
  `tama├▒o` bigint NOT NULL COMMENT 'Tama├▒o en bytes',
  `extensi├│n` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Extensi├│n del archivo (pdf, jpg, png, etc)',
...
CREATE TABLE `asistencias` (
  ...
  `id_sesi├│n` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'FK a la sesi├│n mensual',
  ...
  `justificaci├│n` text COLLATE utf8mb4_unicode_ci COMMENT 'Justificaci├│n presentada por el socio (opcional)',
  `justificaci├│n_pdf` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Archivo PDF de la justificaci├│n',
  `justificaci├│n_aprobada` tinyint(1) DEFAULT '0' COMMENT 'Indica si la justificaci├│n fue aprobada',
  ...
  UNIQUE KEY `id_socio` (`id_socio`,`id_sesi├│n`),
  ...
  CONSTRAINT `asistencias_ibfk_2` FOREIGN KEY (`id_sesi├│n`) REFERENCES `sesiones_mensuales` (`id_sesi├│n`),
...
CREATE TABLE `cantones` (
  `id_cant├│n` int NOT NULL AUTO_INCREMENT COMMENT 'Identificador num├®rico del cant├│n',
...
--
-- Table structure for table `catastro_entidades_p├║blicas`
--

DROP TABLE IF EXISTS `catastro_entidades_p├║blicas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `catastro_entidades_p├║blicas` (
  ...
  `raz├│n_social` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Raz├│n social de la entidad',
...
--
-- Dumping data for table `catastro_entidades_p├║blicas`
--

LOCK TABLES `catastro_entidades_p├║blicas` WRITE;
/*!40000 ALTER TABLE `catastro_entidades_p├║blicas` DISABLE KEYS */;
/*!40000 ALTER TABLE `catastro_entidades_p├║blicas` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cobros` (
  ...
  `id_sesi├│n` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'FK a la sesi├│n mensual donde se registra el cobro',
  `tipo` enum('aporte_obligatorio','aporte_excedente','cuota_cr├®dito','multa','inversi├│n','inter├®s','desembolso','otro') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de cobro',
  ...
  `medio_pago` enum('efectivo','transferencia','compensaci├│n','digital') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Medio de pago utilizado',
  ...
  `motivo_anulaci├│n` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Motivo de la anulaci├│n',
  `fecha_anulaci├│n` datetime DEFAULT NULL COMMENT 'Fecha de anulaci├│n',
  ...
  KEY `idx_cobros_sesi├│n` (`id_sesi├│n`),
  KEY `idx_cobros_fecha` (`fecha_registro`),
  CONSTRAINT `cobros_ibfk_1` FOREIGN KEY (`id_socio`) REFERENCES `socios` (`id_socio`),
  CONSTRAINT `cobros_ibfk_2` FOREIGN KEY (`id_sesi├│n`) REFERENCES `sesiones_mensuales` (`id_sesi├│n`),
...
CREATE TABLE `cr├®ditos` (
  ...
  `id_sesi├│n_aprobaci├│n` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'FK a la sesi├│n donde se aprob├│ el cr├®dito',
  ...
  `tasa_inter├®s` decimal(5,2) NOT NULL COMMENT 'Tasa de inter├®s anual aplicada',
  `m├®todo_inter├®s` enum('simple','franc├®s','alem├ín') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'M├®todo de inter├®s aplicado a este cr├®dito',
  `destino` text COLLATE utf8mb4_unicode_ci COMMENT 'Destino o prop├│sito del cr├®dito',
  `estado` enum('pendiente','en_revisi├│n','aprobado','rechazado','desembolsado','cancelado') COLLATE utf8mb4_unicode_ci DEFAULT 'pendiente' COMMENT 'Estado actual de la solicitud de cr├®dito',
  `acta_aprobaci├│n_pdf` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Archivo PDF del acta de aprobaci├│n',
  `fecha_solicitud` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de solicitud del cr├®dito',
  `fecha_aprobaci├│n` datetime DEFAULT NULL COMMENT 'Fecha de aprobaci├│n',
  ...
  PRIMARY KEY (`id_cr├®dito`),
  KEY `id_producto` (`id_producto`),
  KEY `id_sesi├│n_aprobaci├│n` (`id_sesi├│n_aprobaci├│n`),
  KEY `usuario_aprueba` (`usuario_aprueba`),
  KEY `idx_cr├®ditos_estado` (`estado`),
  KEY `idx_cr├®ditos_socio` (`id_socio`),
  CONSTRAINT `cr├®ditos_ibfk_1` FOREIGN KEY (`id_socio`) REFERENCES `socios` (`id_socio`),
  CONSTRAINT `cr├®ditos_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos_financieros` (`id_producto`),
  CONSTRAINT `cr├®ditos_ibfk_3` FOREIGN KEY (`id_sesi├│n_aprobaci├│n`) REFERENCES `sesiones_mensuales` (`id_sesi├│n`),
  CONSTRAINT `cr├®ditos_ibfk_4` FOREIGN KEY (`usuario_aprueba`) REFERENCES `usuarios` (`id_usuario`)
...
--
-- Dumping data for table `cr├®ditos`
--

LOCK TABLES `cr├®ditos` WRITE;
/*!40000 ALTER TABLE `cr├®ditos` DISABLE KEYS */;
/*!40000 ALTER TABLE `cr├®ditos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cuentas_ahorro` (
  ...
  `fecha_├║ltimo_movimiento` datetime DEFAULT NULL COMMENT 'Fecha del ├║ltimo movimiento registrado',
...
CREATE TABLE `garantes` (
  ...
  CONSTRAINT `garantes_ibfk_1` FOREIGN KEY (`id_credito`) REFERENCES `cr├®ditos` (`id_cr├®dito`) ON DELETE CASCADE,
...
CREATE TABLE `historial_operaciones` (
  `id_operaci├│n` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Identificador ├║nico de la operaci├│n (UUID)',
  `id_socio` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'FK al socio asociado a la operaci├│n',
  `tipo_operaci├│n` enum('aporte_obligatorio','aporte_excedente','retiro_ahorro','desembolso_cr├®dito','pago_cuota','pago_multa','inversi├│n_apertura','inversi├│n_retiro','inter├®s_ganado','inter├®s_pagado','cierre_sesi├│n','anulaci├│n') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de operaci├│n financiera',
  ...
  `id_sesi├│n` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'FK a la sesi├│n mensual',
  ...
  CONSTRAINT `historial_operaciones_ibfk_2` FOREIGN KEY (`id_sesi├│n`) REFERENCES `sesiones_mensuales` (`id_sesi├│n`),
...
CREATE TABLE `inversiones` (
  `id_inversi├│n` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Identificador ├║nico de la inversi├│n (UUID)',
  ...
  `notificado_devoluci├│n` tinyint(1) DEFAULT '0' COMMENT 'Indica si se notific├│ la pr├│xima devoluci├│n',
...
CREATE TABLE `multas` (
  ...
  `id_sesi├│n` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'FK a la sesi├│n donde se gener├│ la multa',
  `tipo` enum('retraso_10min','retraso_30min','inasistencia','mora_cr├®dito','otro') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de multa',
  `monto` decimal(10,2) NOT NULL COMMENT 'Monto de la multa en USD',
  `justificaci├│n` text COLLATE utf8mb4_unicode_ci COMMENT 'Justificaci├│n presentada por el socio',
  `justificaci├│n_aprobada` tinyint(1) DEFAULT '0' COMMENT 'Indica si la justificaci├│n fue aprobada',
  `justificaci├│n_pdf` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Archivo PDF de la justificaci├│n',
  ...
  `fecha_generaci├│n` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de generaci├│n de la multa',
  ...
  CONSTRAINT `multas_ibfk_2` FOREIGN KEY (`id_sesi├│n`) REFERENCES `sesiones_mensuales` (`id_sesi├│n`),
...
CREATE TABLE `notificaciones` (
  `id_notificaci├│n` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Identificador ├║nico de la notificaci├│n (UUID)',
  ...
  `t├¡tulo` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'T├¡tulo de la notificaci├│n',
  `mensaje` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Cuerpo del mensaje',
  `le├¡da` tinyint(1) DEFAULT '0' COMMENT 'Indica si el destinatario ley├│ la notificaci├│n',
  `enviada_pusher` tinyint(1) DEFAULT '0' COMMENT 'Indica si ya se envi├│ por Pusher',
  `fecha_creaci├│n` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de creaci├│n de la notificaci├│n',
  `fecha_lectura` datetime DEFAULT NULL COMMENT 'Fecha en que se ley├│ la notificaci├│n',
  PRIMARY KEY (`id_notificaci├│n`),
  KEY `idx_notificaciones_usuario` (`id_usuario`),
  KEY `idx_notificaciones_socio` (`id_socio`),
  KEY `idx_notificaciones_le├¡da` (`le├¡da`),
...
--
-- Table structure for table `par├ímetros`
--

DROP TABLE IF EXISTS `par├ímetros`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `par├ímetros` (
  `id_par├ímetro` int NOT NULL AUTO_INCREMENT COMMENT 'Identificador num├®rico del par├ímetro',
  `c├│digo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'C├│digo ├║nico del par├ímetro (ej: tasa_inter├®s_cr├®dito)',
  ...
  `tipo` enum('texto','n├║mero','decimal','booleano','color') COLLATE utf8mb4_unicode_ci DEFAULT 'texto' COMMENT 'Tipo de dato del valor',
  `m├│dulo` enum('general','financiero','seguridad','imagen') COLLATE utf8mb4_unicode_ci DEFAULT 'general' COMMENT 'M├│dulo al que pertenece el par├ímetro',
  `editable` tinyint(1) DEFAULT '1' COMMENT 'Indica si el par├ímetro puede ser editado desde el panel',
  PRIMARY KEY (`id_par├ímetro`),
  UNIQUE KEY `c├│digo` (`c├│digo`)
...
--
-- Dumping data for table `par├ímetros`
--

LOCK TABLES `par├ímetros` WRITE;
/*!40000 ALTER TABLE `par├ímetros` DISABLE KEYS */;
INSERT INTO `par├ímetros` VALUES (1,'tasa_inter├®s_cr├®dito','Tasa de inter├®s para cr├®ditos','6.00','decimal','financiero',1),(2,'m├®todo_inter├®s_default','M├®todo de inter├®s por defecto','simple','texto','financiero',1),(3,'tasa_inter├®s_ahorro','Tasa de inter├®s sobre ahorros','0.00','decimal','financiero',1),(4,'tasa_inter├®s_inversi├│n','Tasa de inter├®s para inversiones','6.00','decimal','financiero',1),(5,'aporte_obligatorio_mensual','Aporte obligatorio mensual','10.00','decimal','financiero',1),(6,'cuota_ingreso','Cuota ├║nica de ingreso','20.00','decimal','financiero',1),(7,'multa_retraso_10min','Multa retraso 10-30 minutos','1.00','decimal','financiero',1),(8,'multa_retraso_30min','Multa retraso >=30 minutos','5.00','decimal','financiero',1),(9,'multa_inasistencia','Multa por inasistencia','5.00','decimal','financiero',1),(10,'multa_mora_cr├®dito','Multa por mora de cr├®dito','5.00','decimal','financiero',1),(11,'l├¡mite_cr├®dito_emergente','L├¡mite cr├®dito emergente','300.00','decimal','financiero',1),(12,'plazo_m├¡nimo_inversi├│n','Plazo m├¡nimo inversi├│n (meses)','6','n├║mero','financiero',1),(13,'intentos_m├íx_login','Intentos m├íximo de login','3','n├║mero','seguridad',1),(14,'bloqueo_minutos','Minutos de bloqueo','15','n├║mero','seguridad',1),(15,'session_timeout_minutos','Timeout de sesi├│n (minutos)','30','n├║mero','seguridad',1),(16,'pin_2fa_d├¡gitos','D├¡gitos del PIN 2FA','6','n├║mero','seguridad',1),(17,'pin_2fa_expiracion_min','Expiraci├│n PIN 2FA (minutos)','5','n├║mero','seguridad',1),(18,'m├íx_reenv├¡o_pin_hora','M├íximo reenv├¡os PIN por hora','3','n├║mero','seguridad',1),(19,'logo_sidebar','Logo del sidebar','ca62b9e0-de01-42cc-9bb6-0826f49dce00','texto','imagen',1),(20,'logo_sd','Logo sin fondo','d9433f2e-ffa1-48c9-bf86-b338e6796ff2','texto','imagen',1);
/*!40000 ALTER TABLE `par├ímetros` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `permisos` (
  ...
  `c├│digo` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'C├│digo ├║nico del permiso (ej: socio.registrar)',
  `nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nombre descriptivo del permiso',
  `descripci├│n` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Descripci├│n detallada del alcance del permiso',
  PRIMARY KEY (`id_permiso`),
  UNIQUE KEY `c├│digo` (`c├│digo`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Cat├ílogo de permisos disponibles en el sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `productos_financieros` (
  ...
  `tipo` enum('cr├®dito','inversi├│n') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de producto: cr├®dito o inversi├│n',
  `tasa_inter├®s_anual` decimal(5,2) NOT NULL DEFAULT '6.00' COMMENT 'Tasa de inter├®s anual en porcentaje',
  `m├®todo_inter├®s` enum('simple','franc├®s','alem├ín') COLLATE utf8mb4_unicode_ci DEFAULT 'simple' COMMENT 'M├®todo de c├ílculo de intereses',
  `plazo_m├¡n_meses` int NOT NULL COMMENT 'Plazo m├¡nimo en meses',
  `plazo_m├íx_meses` int NOT NULL COMMENT 'Plazo m├íximo en meses',
  `monto_m├¡n` decimal(10,2) NOT NULL COMMENT 'Monto m├¡nimo del producto',
  `monto_m├íx` decimal(10,2) NOT NULL COMMENT 'Monto m├íximo del producto',
  ...
  `fecha_creaci├│n` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de creaci├│n del producto',
...
INSERT INTO `productos_financieros` VALUES ('802ad839-cfec-46aa-869f-9910912ea142','Inversi├│n 12 Meses','inversi├│n',7.00,'simple',12,12,100.00,10000.00,0,10.00,1,'2026-06-06 14:16:51'),('900f2e04-b730-4bbf-9d83-d9c79ea6849e','Cr├®dito Ordinario','cr├®dito',6.00,'simple',1,12,50.00,1500.00,1,0.00,1,'2026-06-06 14:16:51'),('97daba5b-f71d-49aa-a826-b7f01c81fac1','Cr├®dito Agr├¡cola','cr├®dito',5.00,'franc├®s',3,24,100.00,5000.00,1,0.00,1,'2026-06-06 14:16:51'),('b53305e5-5102-49c0-9176-d164d3e98c58','Inversi├│n 120 d├¡as','inversi├│n',6.00,'simple',3,3,50.00,5000.00,0,5.00,1,'2026-06-06 14:16:51'),('c5f8ab97-9808-4919-9e05-b6f89f473538','Cr├®dito Emergente','cr├®dito',6.00,'simple',1,6,10.00,300.00,0,0.00,1,'2026-06-06 14:16:51');
...
CREATE TABLE `roles` (
  ...
  `descripci├│n` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Descripci├│n de las funciones del rol',
...
INSERT INTO `roles_permisos` VALUES (1,1,1),(1,2,1),(1,6,1),(1,7,1),(1,8,1),(1,9,1),(1,10,1),(1,11,1),(1,26,1),(2,1,1),(2,2,1),(2,3,1),(2,4,1),(2,5,1),(2,6,1),(2,7,1),(2,21,1),(2,22,1),(2,25,1),(2,26,1),(2,27,1),(2,28,1),(3,1,1),(3,2,1),(3,4,1),(3,6,1),(3,7,1),(3,12,1),(3,13,1),(3,14,1),(3,15,1),(3,21,1),(3,22,1),(3,23,1),(3,24,1),(3,26,1),(3,27,1),(3,28,1),(4,1,1),(4,2,1),(4,3,1),(4,4,1),(4,6,1),(4,7,1),(4,16,1),(4,17,1),(4,18,1),(4,19,1),(4,20,1),(4,21,1),(4,22,1),(4,26,1),(4,27,1),(4,28,1),(5,1,1),(5,6,1),(5,7,1),(5,16,1),(5,17,1),(5,18,1),(5,19,1),(5,26,1),(5,28,1),(6,1,1),(7,1,1),(7,2,1),(7,3,1),(7,4,1),(7,5,1),(7,6,1),(7,7,1),(7,16,1),(7,26,1);
...
CREATE TABLE `sesiones_mensuales` (
  `id_sesi├│n` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Identificador ├║nico de la sesi├│n mensual (UUID)',
  `n├║mero_sesi├│n` int NOT NULL COMMENT 'N├║mero correlativo de la sesi├│n mensual',
  `fecha` date NOT NULL COMMENT 'Fecha de la sesi├│n mensual',
  `t├¡tulo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'T├¡tulo o nombre de la sesi├│n',
...
CREATE TABLE `socios` (
  ...
  `c├®dula` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'C├®dula de identidad ecuatoriana (10 d├¡gitos, d├¡gito verificador)',
  ...
  `g├®nero` enum('masculino','femenino') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'G├®nero del socio',
  `estado_civil` enum('soltero','casado','divorciado','viudo','uni├│n_libre') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Estado civil del socio',
  `direcci├│n` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Direcci├│n de residencia',
  `tel├®fono` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'N├║mero de tel├®fono fijo',
  `celular` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'N├║mero de celular',
  `correo_electr├│nico` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Correo electr├│nico (validado con PIN 6 d├¡gitos)',
  `profesi├│n` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Profesi├│n u ocupaci├│n',
  ...
  `fecha_aprobaci├│n` date DEFAULT NULL COMMENT 'Fecha de aprobaci├│n por la Asamblea',
  `n├║mero_acta_aprobaci├│n` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'N├║mero de acta de la Asamblea que aprob├│ el ingreso',
  `acta_aprobaci├│n_pdf` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Archivo PDF del acta de aprobaci├│n',
  ...
  `fecha_exclusi├│n` date DEFAULT NULL COMMENT 'Fecha de exclusi├│n (Art.14 Estatuto)',
  `motivo_exclusi├│n` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Motivo de la exclusi├│n',
  ...
  `representante_c├®dula` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'C├®dula del representante legal',
  `representante_tel├®fono` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Tel├®fono del representante legal',
  ...
  `hash_integridad` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SHA-256 de integridad del registro',
  `fecha_creaci├│n` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de creaci├│n del registro',
  PRIMARY KEY (`id_socio`),
  UNIQUE KEY `c├®dula` (`c├®dula`),
  UNIQUE KEY `correo_electr├│nico` (`correo_electr├│nico`),
  KEY `idx_socios_c├®dula` (`c├®dula`),
  KEY `idx_socios_correo` (`correo_electr├│nico`),
...
CREATE TABLE `usuarios` (
  ...
  `c├®dula` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'C├®dula de identidad ecuatoriana',
  `correo_electr├│nico` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Correo electr├│nico del usuario',
  `tel├®fono` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'N├║mero de tel├®fono',
  `nombre_usuario` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nombre de usuario para inicio de sesi├│n',
  `contrase├▒a` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Hash bcrypt de la contrase├▒a',
  ...
  `fecha_creaci├│n` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de creaci├│n del registro',
  `fecha_├║ltimo_acceso` datetime DEFAULT NULL COMMENT 'Fecha y hora del ├║ltimo inicio de sesi├│n exitoso',
  PRIMARY KEY (`id_usuario`),
  UNIQUE KEY `c├®dula` (`c├®dula`),
  UNIQUE KEY `correo_electr├│nico` (`correo_electr├│nico`),
  UNIQUE KEY `nombre_usuario` (`nombre_usuario`),
  KEY `idx_usuarios_c├®dula` (`c├®dula`),
  KEY `idx_usuarios_correo` (`correo_electr├│nico`),
...
INSERT INTO `usuarios` VALUES ('1673019a-c66d-4bb8-9158-1729fa6b064a','Gavino','Carranco','1002003000','gavinocg@gmail.com','0996755645','gcarranco','$2y$12$QkuzAcoAFQ7C9f5GMMeGS.1smyFeCvsvJeESlsmkB00oBEfzlLYjO',1,0,0,NULL,0,'2026-06-06 16:38:03','2026-06-07 00:23:17'),('516363c5-c79a-4491-83b4-b8303ce1f286','Tesorero','Caja','1003560438','gcarranco@hotmail.com','','tesorero','$2y$12$/gRI9LwajMIzc8e/NYxO6.hCsUvfbH3c.yxuEKpkpRT7AXoL2ojxe',1,0,0,NULL,0,'2026-06-06 18:23:36','2026-06-06 20:44:40'),('6600ae1d-e99d-4986-b337-0741de09df84','CARLOS MANUEL','VARGAS CRUZ','1766677788','carlos.vargas@email.com','','1766677788','$2y$12$wx0/HsCyDTfUlKWE8twT/uRPv2o/MEOWXbadf9piFa6So5g39Trie',1,0,0,NULL,0,'2026-06-06 19:35:51','2026-06-06 19:44:55'),('ce86e169-fa0a-468d-bb04-ca7b8c7a5291','Admin','Sistema','1002606083','admin@caja.test','0999999999','admin','$2y$12$IP4hst3.3yCimzqw/bO8JOYscRjkeQADlesFcttSetTnxNCRY.N8G',1,0,0,NULL,0,'2026-06-06 14:16:51','2026-06-07 00:15:33');
...
-- Dump completed on 2026-06-07  0:33:20
