...
CREATE TABLE inversiones (
    ...
    estado ENUM('activa','vencida','retiro_anticipado','cancelada') DEFAULT 'activa' COMMENT 'Estado actual de la inversión',
...
CREATE TABLE cobros (
    ...
    tipo ENUM('aporte_obligatorio','aporte_excedente','cuota_crédito','multa','inversión','interes','desembolso','otro') NOT NULL COMMENT 'Tipo de cobro',
...
CREATE TABLE historial_operaciones (
    ...
    tipo_operacion ENUM('aporte_obligatorio','aporte_excedente','retiro_ahorro','desembolso_crédito','pago_cuota','pago_multa','inversión_apertura','inversión_retiro','interes_ganado','interes_pagado','cierre_sesión','anulación') NOT NULL COMMENT 'Tipo de operación financiera',
